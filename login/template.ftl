              ...
              <div class="container">
                  ...
                  <div class="col-xs-12 col-md-4">
                      <div class="block">
                          ...
                          <a href="https://servicedesk.linaro.org/servicedesk/customer/portal/3/create/120" class="pf-c-button pf-m-primary pf-m-block btn-lg">Request an account <i class="pficon-user"></i></a>
                      </div>
                  </div>
                  <div class="col-xs-12 col-md-4">
                      <div class="block">
                          ...
                          <a href="https://servicedesk.linaro.org" class="pf-c-button pf-m-primary pf-m-block btn-lg">Go to Service Desk <i class="pficon-unknown"></i></a>
                      </div>
                  </div>
                  <div class="col-xs-12 col-md-4">
                      <div class="block">
                          ...
                          <a href="https://www.linaro.org/about/" class="pf-c-button pf-m-primary pf-m-block btn-lg">About Us <i class="pficon-info"></i></a>
                      </div>
                  </div>
                  </div>
              </div>
